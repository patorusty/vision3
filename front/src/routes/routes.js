...
let otrosRiesgos = {
  ...
  children: [{
    ...
    component: require('../pages/Polizas/OtrosRiesgos/AccidentePersonal.vue').default
  },
  {
    path: 'combinadofamiliar',
    name: 'Combinado Familiar',
    component: require('../pages/Polizas/OtrosRiesgos/CombinadoFamiliar.vue').default
  },
  {
    path: 'otros',
    name: 'Otros',
...
let administracion = {
  ...
  },
  {
    path: 'organizadores',
    name: 'Organizadores',
    component: require('../pages/Administracion/Organizadores/Organizadores.vue').default
  },
  {
    path: 'productores',
    name: 'Productores',
    component: require('../pages/Administracion/Productores/Productores.vue').default
  },
  {
